...
*/
public enum WebKeyRole {
	// WARNING: Do not rearrange these values, their order is used to codify the fact that 
	// later roles grant all permissions of earlier roles, used in eg SecureUrlHelper
	NONE,
	READ,
	WRITE,
	OWNER
