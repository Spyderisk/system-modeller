...
public class TrustworthinessAttributeSet extends SemanticEntity {
	...
	private Level trustworthinessLevel;
	...
	public void setAttribute(Level attribute) {
		this.attribute = attribute;
	}

	public Level getTrustworthinessLevel() {
		return trustworthinessLevel;
	}

	public void setTrustworthinessLevel(Level trustworthinessLevel) {
		this.trustworthinessLevel = trustworthinessLevel;
	}
}
