...
public class MitigationSet extends SemanticEntity {

	private MisbehaviourSet misbehaviourSet;

	private ControlSet controlSet;

	private Level MitigationLevel;

	public MitigationSet() {}
	...
	public Level getMitigationLevel() {
		return MitigationLevel;
	}

	public void setMitigationLevel(Level MitigationLevel) {
