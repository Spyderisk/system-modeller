 ...
 */
public class SemanticEntity implements Comparable<SemanticEntity> {
	...
	/**
	 * Get all superclasses of the entity.
	 *
	 * @return a set of URIs of the superclasses
	 */
	...
	public boolean equals(Object other) {
		...
		if (SemanticEntity.class.isAssignableFrom(other.getClass())) {
			return uri.equals(((SemanticEntity) other).getUri());
		}
