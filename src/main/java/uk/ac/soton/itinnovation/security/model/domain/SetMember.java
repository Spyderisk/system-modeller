...
public class SetMember extends SemanticEntity {

	private final Set<String> metaLocatedAt;

	public SetMember() {
		metaLocatedAt = new HashSet<>();
	}

	public Set<String> getMetaLocatedAt() {
		return metaLocatedAt;
	}
