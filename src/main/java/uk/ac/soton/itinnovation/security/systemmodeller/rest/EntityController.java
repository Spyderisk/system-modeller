...
public class EntityController {
	 ...
	 *
	 * @param modelId the String representation of the model object to seacrh
	 * @param misbehaviourURI misbehaviour URI
	 * @return A JSON representation of a threat object
     * @throws InternalServerErrorException   if an error occurs during report generation
	 */
	@RequestMapping(value = "/models/{modelId}/entity/system/misbehaviours/{systemMisbehaviourSetURI}", method = RequestMethod.GET)
	public ResponseEntity<MisbehaviourSetDB> getEntitySystemMisbehaviourSet(
            @PathVariable String modelId,
            @PathVariable String systemMisbehaviourSetURI) {

        logger.error("get system misbihaviour for model {} with URI: {}", modelId, systemMisbehaviourSetURI);
        ...
        try {
            ...
            MisbehaviourSetDB ms = querierDB.getMisbehaviourSet(systemMisbehaviourSetURI, "system-inf");
     ...
     * @throws InternalServerErrorException   if an error occurs during report generation
	 */
	@RequestMapping(value = "/models/{modelId}/entity/system/misbehaviours", method = RequestMethod.GET)
     ...
     * @throws InternalServerErrorException   if an error occurs during report generation
	 */
	@RequestMapping(value = "/models/{modelId}/entity/system/twas/{twaURI}", method = RequestMethod.GET)
     ...
     * @throws InternalServerErrorException   if an error occurs during report generation
	 */
	@RequestMapping(value = "/models/{modelId}/entity/system/twas", method = RequestMethod.GET)
     ...
     * @throws InternalServerErrorException   if an error occurs during report generation
	 */
	@RequestMapping(value = "/models/{modelId}/entity/domain/misbehaviours/{misbehaviourURI}", method = RequestMethod.GET)
	public ResponseEntity<MisbehaviourDB> getEntityDomainMisbehaviour(
            @PathVariable String modelId,
            @PathVariable String misbehaviourURI) {

        logger.error("get domain Misbehaviour for model {} with URI: {}", modelId, misbehaviourURI);
        ...
        try {
            ...
            MisbehaviourDB misbehaviour = querierDB.getMisbehaviour(misbehaviourURI, "domain");
     ...
     * @throws InternalServerErrorException   if an error occurs during report generation
     */
	@RequestMapping(value = "/models/{modelId}/entity/domain/{metric}/level/{levelURI}", method = RequestMethod.GET)
     ...
     * @throws InternalServerErrorException   if an error occurs during report generation
     */
	@RequestMapping(value = "/models/{modelId}/entity/domain/{metric}/levels", method = RequestMethod.GET)
