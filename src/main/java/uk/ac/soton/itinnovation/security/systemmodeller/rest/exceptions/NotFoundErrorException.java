...
/** 
 * Generic exception to use for not found 404, which can display any provided
 * error mesage. 
 * Commonly used error messages such as in 'ModelInvalidException' are defined as
 * additional custom 404 exceptions
 * 
